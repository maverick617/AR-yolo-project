...
namespace AR80sRetro
{
    ...
    public sealed class AdditionalAprilTagMount
    {
        ...
        [Tooltip("Enable when this mount needs a different cup-center offset model.")]
        ...
        [Tooltip("Use half the measured cup height instead of half the measured body diameter.")]
    ...
    public sealed class RetroReplacementRule
    {
        ...
        [Tooltip("Use configured rigid mounts to convert every Tag into one common cup/handle frame.")]
